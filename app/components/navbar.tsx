    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4 ">
        ...
        {session ? (
          ...
          <Button white={false} className=" sim-card-button hidden md:hidden lg:flex " onClick={() => signOut()}>
            Sign out
          </Button>


        ) : (<Link href="/signup">
          <Button white={false} className="sim-card-button hidden md:hidden lg:flex " >
            Sign in
          </Button>
        </Link>)}
