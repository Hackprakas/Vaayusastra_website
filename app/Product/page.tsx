                ...
                <div className="p-8 bg-n-8 rounded-[2.4375rem] overflow-hidden w-full">
                    ...
                    <form className="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input type="text" name="upi" id="upi" className="bg-gray-700 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="your-upi-id@bank" />
                        </div>
                        <p className="font-extrabold text-center text-white">or</p>
                        <div>
                            <label htmlFor="cardNumber" className="block mb-2 text-sm font-medium text-white">Card Number</label>
                            <input type="text" name="cardNumber" id="cardNumber" className="bg-gray-700 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="1234 5678 9012 3456" required />
                        </div>
                        <div className="flex space-x-2">
                            <div className="w-1/2">
                                <label htmlFor="expiryDate" className="block mb-2 text-sm font-medium text-white">Expiry Date</label>
                                <input type="text" name="expiryDate" id="expiryDate" className="bg-gray-700 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="MM/YY" required />
                            </div>
                            <div className="w-1/2">
                                <label htmlFor="cvv" className="block mb-2 text-sm font-medium text-white">CVV</label>
                                <input type="text" name="cvv" id="cvv" className="bg-gray-700 text-white sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="•••" required />
                            </div>
                        </div>
